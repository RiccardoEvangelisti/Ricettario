package com.myproject.ricettario.application;
...
import com.myproject.ricettario.controllers.ScreenPrimaryController;
...
public class MainRicettario extends Application {
	...
	/**
	 * 1.0.01 : Tolta la possibilit� di aggiungere qualsiasi file. <br>
	...
	public void start(Stage primaryStage) {
		 ...
		 * Lo ScreenPrimary � un BorderPane con al centro un AnchorPane con tutti i nodi.
		 * Vengono caricati anche lo screen di aggiungi ricetta e di vedi ricetta.
		 */
		BorderPane screenPrimary = null;
		try {
			System.out.println(getClass().getResource(ScreenPrimaryURL));
